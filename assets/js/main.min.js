...
$(document).ready(function(){"use strict";$("#sidebar-toggle").on("click",function(){$("body").toggleClass("sidebar-hidden")}),feather.replace(),function(){var e=$(".accordion-menu li:not(.open) ul"),o=$(".accordion-menu li.active-page > a");e.hide();$(".accordion-menu li a").on("click",function(e){var o=$(this).next("ul"),n=$(this).parent("li"),a=$(".accordion-menu > li.open");if(o.length)return console.log(o.length),n.hasClass("open")?(o.slideUp(200),n.removeClass("open")):(a.length&&($(".accordion-menu > li.open > ul").slideUp(200),a.removeClass("open")),o.slideDown(200),n.addClass("open")),!1}),$(".active-page > ul").length&&o.click()}(),function(){$('[data-bs-toggle="popover"]').popover(),$('[data-bs-toggle="tooltip"]').tooltip();var e=document.querySelectorAll(".needs-validation");Array.prototype.slice.call(e).forEach(function(e){e.addEventListener("submit",function(o){e.checkValidity()||(o.preventDefault(),o.stopPropagation()),e.classList.add("was-validated")},!1)})}()}),$(window).on("load",function(){setTimeout(function(){$("body").addClass("no-loader")},1e3)});